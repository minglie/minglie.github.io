...
for (function (a) {
    a.fn.qrcode = function (b) {
        ...
        return "string" == typeof b && (b = {text: b}),
            ...
            var c, d, e, f, g, h, i, j, k, a = new Ming_qrcode(b.typeNumber, b.correctLevel);
            ...
            d = function () {
                var d, e, f, g, h, i,
                    c = new Ming_qrcode(b.typeNumber, b.correctLevel);
    ...
    addData: function (a) {
        ...
        this.setupPositionProbePattern(0, 0), this.setupPositionProbePattern(this.moduleCount - 7, 0), this.setupPositionProbePattern(0, this.moduleCount - 7), this.setupPositionAdjustPattern(), this.setupTimingPattern(), this.setupTypeInfo(a, b), this.typeNumber >= 7 && this.setupTypeNumber(a), null == this.dataCache && (this.dataCache = Ming_qrcode.createData(this.typeNumber, this.errorCorrectLevel, this.dataList)), this.mapData(this.dataCache, b)
...
}, Ming_qrcode.PAD0 = 236, Ming_qrcode.PAD1 = 17, Ming_qrcode.createData = function (a, b, c) {
    ...
    for (; ;) {
        ...
        if (e.put(Ming_qrcode.PAD0, 8), e.getLengthInBits() >= 8 * h) {
            break
        }
        e.put(Ming_qrcode.PAD1, 8)
    }
    return Ming_qrcode.createBytes(e, d)
}, Ming_qrcode.createBytes = function (a, b) {
