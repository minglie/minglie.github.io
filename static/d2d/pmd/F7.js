...
const help=`
    以<a target="_blank" href="pmd/pmd_template.h">pmd_template.h为模板</a>,以F6_output为参数,生成最终的h文件,例子: <a href="https://gitee.com/-/ide/project/langjie_2/easyxlcdsimulation/edit/dev4byte/-/vs/dm8176/testc/pmdtest.cpp">pmdtest.cpp</a>
...
async function main(param){
    input=param;
    let pmd_template= await M.request.getText("pmd/pmd_template.h")
    let F5_ouput=await F5.main(input);
    let P=await F6.main(F5_ouput);
    let r= ejs.render(pmd_template,{P})
    return r;
}
